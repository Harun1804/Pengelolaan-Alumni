  ...
  <div id="wrapper">
        ...
        <ul class="sidebar navbar-nav">
          ...
          <div class="dropdown-menu" aria-labelledby="pagesDropdown">
            <a class="dropdown-item" href="<?php echo site_url('admin/htmasuk');?>">Tahun Masuk</a>
            <a class="dropdown-item" href="<?php echo site_url('admin/pekerjaan');?>">Pekerjaan</a>
            <a class="dropdown-item" href="<?php echo site_url('admin/kmasukan');?>">Kategori Masukan</a>
          </div>
        </li>
        <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="#" id="pagesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
          <a class="dropdown-item" href="<?php echo site_url('admin/falumni');?>">Full Data</a>
          <a class="dropdown-item" href="<?php echo site_url('admin/jalumni');?>">Jumlah</a>
        </div>
      </li>
          <li class="nav-item">
            <a class="nav-link" href="<?php echo site_url('admin/kotak_saran');?>">
